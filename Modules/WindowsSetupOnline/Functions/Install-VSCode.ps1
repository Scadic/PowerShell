Function Install-VSCode
{
    ...
    Begin
    {
        ...
        {
            Invoke-WebRequest -Uri "https://update.code.visualstudio.com/1.70.3/win32$($OSArch)/stable" -OutFile "$($env:TEMP)\VSCodeSetup.exe" -UseBasicParsing
        }
        ...
        {
            Invoke-WebRequest -Uri "https://code.visualstudio.com/sha/download?build=stable&os=win32$($OSArch)" -OutFile "$($env:TEMP)\VSCodeSetup.exe" -UseBasicParsing
        }
